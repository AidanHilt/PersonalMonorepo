...
install_argocd() {
  ...
  local helm_cmd="helm upgrade --install ''${release_name} argo/argo-cd --namespace ''${namespace} -f 'https://raw.githubusercontent.com/AidanHilt/PersonalMonorepo/refs/heads/main/kubernetes/argocd/values.yaml'"
