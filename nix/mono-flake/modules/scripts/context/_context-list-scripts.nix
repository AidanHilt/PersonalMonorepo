...
# Header
echo -e "''${BOLD}Scripts in ''${BLUE}$(realpath "''$ATILS_CURRENT_CONTEXT_SCRIPTS_DIR")''${NC}''${BOLD}:''${NC}"
echo
...
echo
echo -e "''${GRAY}Found $files_found executable script$([ $files_found -ne 1 ] && echo "s").''${NC}"
'';
in
