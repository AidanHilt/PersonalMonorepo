...
YQ_STRING=".secrets.\"$secret_name\".destination.namespace = \"$destination_namespace\""
...
SECRET_VALUES_FILE="$PERSONAL_MONOREPO_LOCATION/kubernetes/helm-charts/vault-config"
