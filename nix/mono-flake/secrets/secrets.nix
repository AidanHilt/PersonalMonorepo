let
  ...
  staging-cluster-1-system = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIF4TmzSsDf+LtOggQgBZ44m+Nhh0B+f/kmX1hBEx27Oz noname";
  staging-cluster-2-system = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIHD5UIBYy/Asm5EXbR1NXAdVb7y3sLCCa0cuQ6XBE2xv noname";
