...
def compare_yaml_files(yaml_file_1: str, yaml_file_2: str) -> bool:
    ...
    return compare_yaml_strings(yaml_dict_1, yaml_dict_2)
...
def _replace_item_in_yaml_array(
    ...
    """
    Given two dictionaries representing yaml files, replace or append the item at yaml_dict_1[yaml1_array_name][yaml1_array_index]
    with the item at yaml_dict_2[yaml2_array_name][yaml2_array_index]. Return yaml_dict_1 with the items replaced, or appended
