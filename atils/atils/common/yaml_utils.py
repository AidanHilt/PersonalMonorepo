...
def merge_kubeconfigs(kubeconfig1: str, kubeconfig2: str) -> str:
    ...
    # TODO JFC make this generic, right now it only does prod-cluster
    data_1_index = find_item_index("clusters", "prod-cluster", kubeconfig_data1)
    ...
    if data_2_index is not None:
        ...
        kubeconfig_data1["clusters"][data_1_index]["name"] = "prod-cluster"
    else:
    ...
    data_1_index = find_item_index("users", "kube-admin-prod", kubeconfig_data1)
